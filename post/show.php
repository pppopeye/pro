...
FROM post 
INNER JOIN post_detail 
ON post.P_id=post_detail.P_id 
WHERE post.post_name="1" 
ORDER BY post.P_id;';
                    ...
                    foreach ($sth->fetchAll() as $row) {
                        ...
                        <div class="col-xs-12 col-md-3">
                            ...
                            <!--<a href="product_detail.php">
                                ...
                                <img src="<?php echo $row['P_img']; ?>" class="img-rounded" width="250px" height="200px" class="img-rounded"></a>
