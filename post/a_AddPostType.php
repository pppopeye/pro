                ...
                <form method="post" action=""> <!-- style='"background-color:#c1e2b3;' -->
                    ...
                    <div class="col-xs-12 col-md-12">
                        ...
                        <div class="col-xs-7 col-md-6">
                            <input type="text" name="Post_type" id="Post_type" class="form-control">
                        </div>
                        <!-- /col-xs-12 col-sm-3 -->
...
<!-- sql insert status of BlacklistStatus-->
    ...
    if(empty($_POST)) { 
        ...
        try {
            ...
            $sql = $conn->prepare("INSERT INTO post_type (Post_type) VALUES (:Post_type)");             
            $sql->bindParam(':Post_type', $_POST['Post_type']);
            $sql->execute();

            echo "<script>window.location='a_AddPostType.php';</script>";
