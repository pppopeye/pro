...
$sqlSelect = 'SELECT post.*,post_detail.Pd_price FROM post INNER JOIN post_detail ON post.P_id=post_detail.P_id WHERE post.post_name="2" ORDER BY post.P_id;';
